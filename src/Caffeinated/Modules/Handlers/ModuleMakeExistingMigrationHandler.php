...
class ModuleMakeExistingMigrationHandler
{
    /**
     ...
     *
     * @param  \Caffeinated\Modules\Console\ModuleMakeExistingMigrationCommand $console
     * @param  string                                                          $slug
     *
     * @return string
     */
    public function fire(Command $console, $slug, $table)
    {
        ...
        if ($this->module->exists($this->moduleName)) {
            ...
            $this->console->info("Created Module Migration: [$this->moduleName] "
                . $this->getFilename());
    ...
    {
        return $this->finder->put($this->getDestinationFile(),
            $this->getStubContent());
    }
    ...
    protected function getStubContent()
    {
        return $this->formatContent($this->finder->get(__DIR__
            . '/../Console/stubs/migration.existing.stub'));
    }
